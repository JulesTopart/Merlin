...
void ExampleLayer::OnAttach(){
	...
	Shared<Model> floor = Model::Create("floor", Primitives::CreateCube(2, 1.5, 0.1));
	...
	Shared<Mesh> particle = Primitives::CreateSphere(gridWidth / (2.0f*float(gridSize)), 5, 5);
	...
	Console::info("TVE") << sizeof(TVEParticle);
