...
void ExampleLayer::OnAttach(){
	...
	fluid2 = CreateShared<ComputeShader>("heat");
	fluid2->Compile("assets/shaders/particle.heat.glsl");

	//Load models
	axis = ModelLoader::LoadAxis("axis");
	model = ModelLoader::LoadPlane("plane");
	model->translate(glm::vec3(0, 0, -0.01));
	...
	modelShader->Use();
	modelShader->SetUniform3f("lightPos", glm::vec3(0, 0, 10));
